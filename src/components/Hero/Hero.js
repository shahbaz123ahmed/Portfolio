      ...
      <HeroContainer>
        <HeroWrapper>
          ...
          <HeroRight>
            <ScrollAnimation animateIn="fadeIn">
              <Image
                src="/assets/images/whitepic.jpg"
                alt="man-svgrepo"
                className={isPageOver ? "rotate" : ""}
                onMouseEnter={() => setIsPageOver(true)} // Start rotation
                onMouseLeave={() => setIsPageOver(false)} // Stop rotation
